...
void Renderer::Begin()
{
	...
	m_DeviceContext->ClearRenderTargetView(m_RenderTargetView, clearColor);  //レンダーターゲットビューのクリア
	m_DeviceContext->ClearDepthStencilView(m_DepthStencilView, D3D11_CLEAR_DEPTH, 1.0f, 0);  //デプスステンシルビューのクリア
}
...
void Renderer::End()
{
	m_SwapChain->Present(0, 0);//バッファの切り替え
}
